...
const RANDOM_BOUNDS = "37.289854,28.317540,-102.162568,-91.408911"

func TestGetFlightsInZone(t *testing.T) {
	...
	for _, subtest := range goodSubTests {
		t.Run(subtest.Name, func(t *testing.T) {
			feedData, err := client.GetFlightsInZone(subtest.Requester, RANDOM_BOUNDS)
